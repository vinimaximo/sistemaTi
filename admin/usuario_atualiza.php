                    ...
                    <form action="usuario_atualiza.php" method="post" id="form_usuario_atualiza" name="form_usuario_atualiza" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <label for="nivel_usuario_s" class="radio-inline">
                                <input type="radio" name="nivel_usuario" id="nivel_usuario" value="Sim" <?php echo $linha['nivel_usuario'] == "com" ? "checked" : null; ?>>
                                com
                            </label>
                            <label for="nivel_usuario_s" class="radio-inline">
                                <input type="radio" name="nivel_usuario" id="nivel_usuario" value="Não" <?php echo $linha['nivel_usuario'] == "cli" ? "checked" : null; ?>>
                                cli
                            </label>
                            <label for="nivel_usuario_s" class="radio-inline">
                                <input type="radio" name="nivel_usuario" id="nivel_usuario" value="Não" <?php echo $linha['nivel_usuario'] == "sup" ? "checked" : null; ?>>
                                sup
                            </label>
                        </div>
                        <br>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="senha_usuario" name="senha_usuario" maxlength="100" required value="<?php echo $linha['senha_usuario']; ?>" placeholder="Digite a Nova Senha...">
                        </div>
